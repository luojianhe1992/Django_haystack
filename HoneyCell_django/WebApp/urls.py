...
urlpatterns = [
    ...
    url(r'add_blog/$', 'WebApp.views.add_blog', name='add_blog'),

    url(r'show_blogs/$', 'WebApp.views.show_blogs', name='show_blogs'),

    url(r'blog_detail/(?P<blog_id>\d+)$', 'WebApp.views.blog_detail', name='blog_detail'),
